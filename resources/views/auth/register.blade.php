...
<section class="justify-content-center d-flex">
    <div class="shadow-lg k_website_register card">
        <img class="mx-auto k_logo" src="{{ asset('assets/images/logo/logo.png') }}" width="130px" />
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}" class="k_register_form">
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0">{{ __('General Informations') }}</h6>
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0">{{ __('Contact Informations') }}</h6>
                ...
                <div class="mt-2 mb-3 row">
                    <div class="mb-2 col-12">
                        <h6 class="m-0">{{ __('Security Informations') }}</h6>
                ...
                <button class="btn btn-primary float-start text-uppercase font-weight-bold" type="submit">
                ...
                <div class="pt-1 mb-1 text-center k_login_buttons">
                    ...
                    <div class="links-container">
                        @if(Route::has('login'))
                            <a href="{{ route('login')}}" class="login-link">{{ __("Already have an account?") }}</a>
                        @endif
                    </div>
                </div>
