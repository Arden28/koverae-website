...
<head>
    ...
    <meta property="og:title" content="Business Management Software - Koverae">
    <meta property="og:description" content="All-in-one business management platform" />
...
<body class="overflow-hidden">
    <main class="under-dev">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="assets/images/illustrations/under-development.svg" height="" alt="">
            </div>
        </div>
    </main>
